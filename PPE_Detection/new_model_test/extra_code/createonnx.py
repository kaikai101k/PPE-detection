#!/usr/bin/env python3
"""
Export YOLOv8 model to ONNX format with 512x512 image size
Run this script first to convert your .pt model to .onnx
"""
...
model.export(
    format='onnx',
    imgsz=512  # Single value for square images
)
