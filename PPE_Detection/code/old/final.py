...
STABLE_THRESHOLD = 3  # number of consistent frames required to confirm class
...
# Start camera
cam_cmd = [
    "libcamera-vid", "--inline", "--width", str(WIDTH), "--height", str(HEIGHT),
